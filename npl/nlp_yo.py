...
def sp_periodico(subjetividad_periodico,polaridad_periodico):
    print(subjetividad_periodico,polaridad_periodico)
    print(f'La subjetividad media del periodico es: {medias_ps(subjetividad_periodico)}\nLa polaridad media del periodico es: {medias_ps(polaridad_periodico)}')
    """
